    ...
    <div className={styles.body}>
      <div className={styles.left}> 
        ...
        <form action='' className={styles.registerForm}>
          ...
          <input type='text' placeholder='Number' name='mobile' value={data.mobile} onChange={handleChange}/><br/>
          <input type='password' placeholder='Password' name='password' value={data.password} onChange={handleChange}/><br/>
          <label className={styles.check}><input type='checkbox'/>By creating an account, I agree to our terms of use and privacy policy</label><br/>
          <button className={styles.create} onClick={handleSubmit}>Create Account</button>
        </form>
        <p>Already have an account? <span className={styles.signUp} onClick={redirectToSignIn}>Sign In</span></p>
      </div>
