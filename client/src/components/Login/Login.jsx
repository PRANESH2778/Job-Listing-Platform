    ...
    <div className={styles.body}>
      <div className={styles.left}> 
        ...
        <form action='' className={styles.registerForm}>
          ...
          <input type='password' placeholder='Password' name='password' value={loginData.password} onChange={handleChange}/><br/>
          <button className={styles.signIn} onClick={handleSignUp}>Sign in</button>
        </form>
        <p>Don't have an account? <span className={styles.signUp} onClick={redirectToSignUp}>Sign Up</span></p>
      </div>
